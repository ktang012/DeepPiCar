...
from my_traffic_objects import *
...
class ObjectsOnRoadProcessor(object):
    ...
    def __init__(self,
                 car=None,
                 speed_limit=40,
                 model='/home/pi/DeepPiCar/models/object_detection/data/model_result/my_road_signs_quantized_edgetpu.tflite',
                 label='/home/pi/DeepPiCar/models/object_detection/data/model_result/my_road_sign_labels.txt',
                 width=640,
                 height=480):
        ...
        # make sure the road signs label's text file's keys and values matches this
        # and the label map used to train the model!
        self.traffic_objects = {0: Car(),
                                1: SpeedLimit(20),
                                2: SpeedLimit(40),
                                3: Person(),
                                4: StopSign(),
