...
class HandCodedLaneFollower(object):
    ...
    def steer(self, frame, lane_lines):
        ...
        self.curr_steering_angle = new_steering_angle #stabilize_steering_angle(self.curr_steering_angle, new_steering_angle, len(lane_lines))
...
def stabilize_steering_angle(curr_steering_angle, new_steering_angle, num_of_lane_lines, max_angle_deviation_two_lines=1, max_angle_deviation_one_lane=1):
    """
